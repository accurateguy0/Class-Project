...
namespace Gra_RPG
{
    public class CharacterCreationScene : Scene
    {
        ...
        public override void Run()
        {
            ...
            switch(index)
            {
                case 0:
                    ...
                    WriteLine($"Okay, you're a {game.player.Gender}!");
        ...
        public void CustomNameCreator()
        {
            ...
            {
                WriteLine("This name is too long or invalid. Try again");
                ConsoleUtils.WaitForKey();
                CustomNameCreator();
            }
        ...
        public void StatCreator()
        {
         ...
         string prompt = $@"Choose your stats. Your remaining skill points: {game.player.SkillPoints}
